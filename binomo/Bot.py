...
while keyboard.is_pressed("q")==False :
    ...
    if pyautogui.locateOnScreen('time_remainning_30.png',region=[358,183,98,37]) != None:
        ...
        if pyautogui.pixelMatchesColor(1440,1005,(225,221,60),tolerance=50)==True:
            ...
            # elif pyautogui.locateOnScreen('No_internet_connections.png',confidence=0.75,region=[85,870,315,157])!=None:
            #     reload_website()
    else:
        # if pyautogui.locateOnScreen('time_remainning_30.png',region=[358,183,98,37]) != None:
        #     time.sleep(0.1)
        ...
        #         f.check()
            ...
            #     continue
        # else:
        # if pyautogui.locateOnScreen('5_30_notify.png',confidence=0.75) != None:
        #     f.notify_5_30()
        #     time.sleep(0.1)
        #     f.click(1816,650)
        #     time.sleep(0.1)
